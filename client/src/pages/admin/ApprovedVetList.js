...
export default function ApprovedVetList() {
    ...
    const filterVetRecord = vetRecords.filter((record) => {
    ...
    const handleDetailsClick = (element) => {
        const _id = element.record._id.$oid;
        navigate('/approved_vets/' + _id, { state: element.record })
    }


    const getApprovedVets = () => {
